...
por los usuarios a favorito. Para ello recorre la lista de usuarios y usa forin para recoger 
...
pero...a la vez un buen reto y oportunidad para
...
for (const i of can) {
    ...
    console.log(`\nSounds: ${i}\nCantidad de veces en Favoritos: ${sum}`);
}